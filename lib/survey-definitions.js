...
export function getRespondentQuestions(locale) {
  const normalizedLocale = normalizeLocale(locale);
  const translations = getTranslations(normalizedLocale);
  return {
    ...
    pages: [
      {
        ...
        elements: [
          ...
          },
          {
            ...
            name: "name",
            title:
              normalizedLocale === "en" ? "Name or initials" : "Nama atau inisial",
          },
          {
            type: "dropdown",
            name: "domisili",
            title: normalizedLocale === "en" ? "Province" : "Provinsi",
            choices:
              normalizedLocale === "en"
                ? ENGLISH_PROVINCES
          ...
          },
          {
            type: "radiogroup",
            name: "gender",
            title: normalizedLocale === "en" ? "Gender" : "Jenis Kelamin",
            colCount: 3,
            choices:
              normalizedLocale === "en"
                ? ["Man", "Woman", "Trans man", "Trans woman"]
                : ["Laki-laki", "Perempuan", "Translaki", "Transpuan"],
            hasOther: true,
          },
          {
            type: "radiogroup",
            name: "umur",
            title: normalizedLocale === "en" ? "Age" : "Umur",
            colCount: 2,
    ...
    completedHtml: translations.survey.completed,
  };
}
